...
export enum ComponentNameEnum {
  ...
  INPUT = 'Input',
  PERSON_INPUT = 'Input_person',
  CARD_INPUT = 'Input_card',
  CORP_NAME_INPUT = 'Input_corpName',
  CORP_NUM_INPUT = 'Input_corpNum',
  LGPERSON_NAME_INPUT = 'Input_lgpersonName',
  LGPERSON_NUM_INPUT = 'Input_lgpersonNum',
