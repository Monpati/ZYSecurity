export default {
  ...
  login: {
    ...
    telephoneNumber: '手机号',
    telephoneNumberPlaceholder: '请输入手机号',
    email: 'QQ邮箱',
    emailAddress: '请输入QQ邮箱地址',
    code: '验证码',
  ...
  certification: {
    ...
    certDes: '进行实名认证',
    person: '个人认证',
    personDes: '如果您无需进行企业认证，请在这个页面进行个人认证',
    personalInfo: '个人信息',
    realName: '姓名',
    nameIndex: '请输入姓名',
    card_id: '身份证号',
    ...
    complete: '已完成审核',
    corp: '企业认证',
    corpDes: '如果您希望进行企业认证，请在此页面进行操作',
    corpInfo: '企业信息',
    corpDoc: '上传营业执照附件',
    corpDocIndex: '企业法人营业执照',
    corpName: '企业名称',
    corpNameIndex: '请输入企业名称',
    corpNum: '企业注册号',
    corpNumIndex: '请输入企业注册号',
    lgPersonInfo: '法人信息',
    lgPersonCard: '上传法人身份证附件',
    lgPersonName: '法人真实姓名',
    lgPersonNameIndex: '请输入法人姓名',
    lgPersonCardId: '法人身份证件号码',
    lgPersonCardIdIndex: '请输入证件号码'
  },
  analysis: {
    newUser: '新增用户',
