...
const { tableRegister, tableMethods, tableState } = useTable({
  fetchDataApi: async () => {
    ...
    // const res = await fetch('http://192.168.2.114:8080/v1/accounts')
  ...
  setTimeout(() => {
    setProps({
      columns: [
        ...
        {
          field: 'username',
          label: t('tableDemo.username')
        },
        {
          field: 'tel_num',
          label: t('tableDemo.telnum')
        },
        {
          field: 'email',
          label: t('tableDemo.email')
        },
        {
          field: 'balance',
