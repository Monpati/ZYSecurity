...
<template>
  <ContentWrap :title="t('certification.cert')" :message="t('certification.certDes')">
    <el-steps style="max-width: auto" :active="3" align-center>
    ...
    />
    <el-text class="mx-1" size="large">审核通过，您已完成个人实名认证</el-text>
  </ContentWrap>
</template>
