...
import {
  getCorpListApi,
  getTableListApi,
  updateCorpStatusAllow,
  updateCorpStatusReject
} from '@/api/certlist'
...
const { tableRegister, tableMethods, tableState } = useTable({
  fetchDataApi: async () => {
    ...
    const res = await getCorpListApi(data)
  ...
  setTimeout(() => {
    setProps({
      columns: [
        ...
        {
          field: 'corp_name',
          label: t('certification.corp_name')
        },
        {
          field: 'reg_num',
          label: t('certification.reg_num')
        },
        {
          field: 'lgperson',
          label: t('certification.lgperson')
        },
        {
          field: 'lgperson_num',
          label: t('certification.lgperson_num')
        },
        {
          field: 'corp_',
          label: t('certification.corp_address')
        },
        {
          field: 'corp_doc',
          label: t('certification.corp_doc'),
        ...
        {
          field: 'lgperson_front',
          label: t('certification.lgperson_front'),
        ...
        {
          field: 'lgperson_back',
          label: t('certification.lgperson_back'),
...
const redirectToDocImageUrl = (data) => {
  window.open(data.row.corp_doc)
}
...
const allowStatus = async (data) => {
  ...
  const res = await updateCorpStatusAllow(String(data.row.user_id), tmp2)
  return {
    code: res.code,
    message: res.message
  }
...
const rejectStatus = async (data) => {
  ...
  const res = await updateCorpStatusReject(String(data.row.user_id), tmp2)
  return {
    code: res.code,
    message: res.message
  }
